    ...
    class StickyNotesController < ApplicationController
      ...
      def create
        ...
        if sticky_note.save
          ...
          render json: { status: 'ERROR', message: 'Sticky Note could not be created', data: sticky_note.errors },
      ...
      def destroy
        ...
        if sticky_note.destroy
          ...
          render json: { status: 'ERROR', message: 'Sticky Note could not be deleted', data: sticky_note.errors },
                 status: :unprocessable_entity
        end
      end
