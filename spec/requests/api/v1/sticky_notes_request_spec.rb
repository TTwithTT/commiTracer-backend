...
RSpec.describe "Api::V1::StickyNotes", type: :request do
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "successfully creates a new sticky note" do
        ...
        expect {
          post api_v1_user_commit_sticky_notes_path(user_id: user.uid, commit_id: commit.id), params: { sticky_note: { reflection: "Test Reflection" } }
  ...
  describe "DELETE /destroy" do
    let!(:sticky_note) { create(:sticky_note, commit: commit) }
    ...
    context "when the sticky note doesn't exist" do
      it "returns a not found error" do
        ...
        }.not_to change(StickyNote, :count)
